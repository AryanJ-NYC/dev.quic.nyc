      ...
      <div class="row">
        <div class="span9">
          <section id="content" class="body">
            <h1 class="content-title">Fellows</h1>
            <h2>The Queens College Incubator Fellows</h2>
            <h3>Carlos Del Rosario</h3>
            <div class="divInt">
              <div class="circleBoxRight">
                <img src="/images/CarlosDelRosario.jpg" alt="img" title="Carlos Del Rosario" style="" />
              </div>
              <p>Born and raised in the Dominican Republic, I moved to the United States in September of 2010. I am currently a
              Senior at Queens College; Originally pursuing a degree in Telecommunications Engineering I decided to get into the
              Computer Science field. Technology and Computers have always been of my interest; I enjoy learning new things and
              creating something from nothing. Programming has been something I&#39;ve enjoyed since the day I wrote my first line
              of code. This is why participating in the Queens College Incubator to help create things that can benefit society
              while at the same time give experience and teach me new thing is a really great opportunity. In my spare time I enjoy
              learning about new technologies and work on small projects. Among technologies that call my attention right now are
            ...
            <div class="divInt">
              <div class="circleBoxLeft">
                <img src="/images/MatthewBlanco.jpg" />
              </div>
            ...
            <div class="divInt">
              <div class="circleBoxRight">
                <img src="/images/KennethGoodman.jpg" alt="img" title="KennethGoodman.jpg" />
              </div>
            ...
            <div class="divInt">
              <div class="circleBoxLeft">
                <img src="/images/KevinRamsunder.jpg" alt="img" title="KevinRamsunder.jpg" />
              </div>
              <p>My name is Kevin Ramsunder, and I am a third year undergraduate student at Queens College. I started programming
              as a hobby in high school after participating in my school&#39;s Robotics program. Nowadays, my main goal in this
              field is to use technology to improve every aspect of our daily lives. Aside from my own personal projects, I enjoy
              coding collaboratively with others who share the same passion for creating useful and innovative software. I am also
              a believer in the Open-Source movement and its mission to make software free for the community. At the Queens College
              Incubator, I am interested in the Starter Jobs task in hopes that the project will have a real world impact for
              people who are having trouble finding jobs. My resume is available here. My website is KevinRamsunder.com.</p>
            </div>
            <h3>Miriam Striks</h3>
            <div class="divInt">
              <div class="circleBoxRight">
                <img src="/images/MiriamStriks.jpg" alt="img" title="MiriamStriks.jpg" />
              </div>
              ...
              management for Fortune 500 clients. I look forward to contributing to projects at the Queens College incubator,
            ...
            the Queens College technology incubator is on the Starter Jobs and Flushing Chamber of Commerce projects.</p>
            <h3>Alexander Malahoff</h3>
            <div class="divInt">
              <div class="circleBoxRight">
                <img src="/images/AlexanderMalahoff.jpg" alt="img" title="AlexanderMalahoff.jpg" />
              </div>
